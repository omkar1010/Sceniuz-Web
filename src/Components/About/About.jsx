...
import philosophy_image from "../Assets/about-philosophy-image.svg";
import our_purpose_image from "../Assets/about-our-purpose.svg";
import data_collection from "../Assets/data-collection.svg";
      ...
      <div className="about-page-wrapper">
        <div className="about-page-data-container">
          <div className="about-text-container flex flex-col flex-nowrap content-around items-center gap-4 p-5 md:text-base">
            <h1 className="about-text-header">To Vision</h1>
