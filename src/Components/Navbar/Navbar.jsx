...
const Navbar = () => {
    return (
        <>
                <header
        className="relative flex flex-wrap sm:justify-start sm:flex-nowrap z-50 w-full bg-white text-sm py-3 border-b-2">
        <nav
          className="w-full mx-auto px-7 sm:flex sm:items-center sm:justify-between"
          aria-label="Global"
        >
